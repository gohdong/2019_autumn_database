...
class StoreRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Row(
        children: <Widget>[
          Column(children: <Widget>[Container(child: getPackageImage(),width: 100,height: 100,)],),
          Column(
            children: <Widget>[
              Row(children: <Widget>[getPackageName()],),
//              or text
              Row(children: <Widget>[getPackageDescription()],),
//              or text
              Row(
                children: <Widget>[
                  Column(children: <Widget>[getPackagePrice2()],),
//              or text
                  Column(children: <Widget>[getPackagePrice1()],),
//              or text
                ],
              )
//              or text
