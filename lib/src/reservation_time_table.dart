...
//    this.sublist.clear();
  ...
  Widget build(BuildContext context) {
//    print("아래에 영화 영어이름?");
//    print(widget.document_movie['en_name']);
...
////                      if(check == 0){
////                        return Add_array(context, snapshot.data.documents);
////                        }
////                      return Column(
////                        children: <Widget>[
          ...
          Column( // row : 옆으로
            children: <Widget>[
              Container(
                ...
                height: 40.0,
                child: Text(
                  document['theater'] + "관", textAlign: TextAlign.center,
                  style: TextStyle(
                    fontSize: 15,
